...
errors = open("src/support/errors/languages/messages."+sys.argv[1]).readlines()
errors = [x for x in errors if x.strip() != "" and not x.startswith("#")]

h1 = open("src/support/errors/generated/errors.inc","w")
h2 = open("src/support/errors/generated/errors.asm","w")
